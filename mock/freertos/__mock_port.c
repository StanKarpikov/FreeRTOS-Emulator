...
//    printf("Global tick\n");
//    bool found = false;
//    for ( int lIndex = 0; lIndex < MAX_NUMBER_OF_TASKS; lIndex++ )
//    {
//        if(pxThreads[ lIndex ].hThread  && pthread_self() == pxThreads[ lIndex ].hThread )
//        {
//            found = true;
//            break;
//        }
